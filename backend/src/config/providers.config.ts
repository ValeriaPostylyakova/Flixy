...
import { GoogleProviderService } from 'src/auth/provider/services/google.provider'
import { TypeOptions } from 'src/auth/provider/services/provider.constants'
import { YandexProviderService } from 'src/auth/provider/services/yandex.provider'
